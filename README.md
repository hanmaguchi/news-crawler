...
- 감성분석: **키워드 사전(기본·빠름)** / **KR-FinBert AI 모델(선택·정확)** 토글
  — AI도 CPU로 동작하며 GPU 불필요. 모드는 검색 버튼을 누를 때 적용된다
- 필터링: 언론사 필터·블랙리스트, **제목 키워드 필터**, 결과 정렬·검색
- 엑셀(.xlsx)·CSV·JSON 내보내기 — 엑셀 링크 셀은 "기사보기"만 표시되고
  마우스를 올리면 실제 URL이 툴팁으로 보임
